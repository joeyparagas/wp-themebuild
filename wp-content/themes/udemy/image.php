<!-- 
  Image File Page Template
  Similar to attachment.php 
  Template that shows images only using WP template page instead of media window
 -->
              ...
              <div class="single-post nobottommargin">
                ...
                <div class="entry clearfix">
                  ...
                  <div class="entry-content notopmargin">
                    ...
                    <img src="<?php echo $post->guid; ?>" class="image-responsive">
                    <?php
